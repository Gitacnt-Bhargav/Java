...
public class designAStackWithIncrementOperationWithMinTimeComplexity {
...
*/
    ...
    public static void main(String[] args) {
        designAStackWithIncrementOperationWithMinTimeComplexity stk = new designAStackWithIncrementOperationWithMinTimeComplexity(3);
        stk.push(1);                          // stack becomes [1]
        stk.push(2);                          // stack becomes [1, 2]
    ...
    int maxSize;
    int index;
    public designAStackWithIncrementOperationWithMinTimeComplexity(int maxSize){
    ...
    public void increment(int k, int val) {
        int idx = Math.min(k-1, index); //here the topmost element of inc is to be updated, which is index
        if(idx>=0){
            inc[idx] += val;
        }
    }
